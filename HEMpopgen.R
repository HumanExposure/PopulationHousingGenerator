...
read.pums = function() {
  ...
  pums1 <- y[str_detect(g$gender,y$gender) & str_detect(g$race,y$race) & str_detect(g$ethnic,y$ethnicity)]
  if (nrow(pums1)==0) stop("No suitable persons found in PUMS database")
  return(pums1)
}  
